...
@pytest.mark.parametrize('msg,expected', [
    # Basic testcases
    ('https://www.tiktok.com/@user/video/some_id', 'https://www.tiktok.com/@user/video/some_id'),
    ('i sent https://www.tiktok.com/@user/video/some_id', 'https://www.tiktok.com/@user/video/some_id'),
    ('do i https://www.tiktok.com/@user/video/some_id like', 'https://www.tiktok.com/@user/video/some_id'),
    ('do i https://www.tiktok.com/@user/video/some_id like', 'https://www.tiktok.com/@user/video/some_id'),
    ('https://www.tiktok.com/@user/video/some_id like', 'https://www.tiktok.com/@user/video/some_id'),
